...
namespace backend{
    ...
    void edgepiror::ComputeResidual(){
        Eigen::Matrix<double, Eigen::Dynamic, 1> param_i = verticies_[0]->Parameters();
    ...
    void edgepiror::ComputeJacobians(){
        Eigen::Matrix<double, Eigen::Dynamic, 1> param_i = verticies_[0]->Parameters();
        Eigen::Quaterniond Qi(param_i[6], param_i[3], param_i[4], param_i[5]);
    ...
    #endif
        jacobian_pose_i.block<3,3>(3,0) = Eigen::Matrix<double, 3, 3>::Identity();
